...
namespace DataSetHandling
{
    ...
    public class BooleanDimension : DataDimension, INumericalDimension
    {
        ...
        #region Casting
        public static implicit operator List<bool>(BooleanDimension dimension) => dimension._values.Select(v => v).ToList();

        public static implicit operator List<float>(BooleanDimension dimension) => dimension._values.Select((v, i) => dimension.ConvertToFloat(i)).ToList();
        #endregion
