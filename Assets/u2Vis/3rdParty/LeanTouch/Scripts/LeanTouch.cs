...
namespace Lean.Touch
{
	...
	public class LeanTouch_Editor : Editor
	{
		...
		private void DrawSettings(LeanTouch touch)
		{
            ...
            DrawDefault("SimulateTouchByMouse");
...
namespace Lean.Touch
{
	...
	public partial class LeanTouch : MonoBehaviour
	{
        ...
        [Tooltip("Determines if mouse interaction are interpreted as fingers")]
        public bool SimulateTouchByMouse = true;
		...
		private void PollFingers()
		{
			...
			else if (SimulateTouchByMouse && AnyMouseButtonSet == true)
			{
